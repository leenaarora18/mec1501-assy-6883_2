...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0xe0000 + 0x0), LENGTH = (224 * 1024 - 0x0 - 0x0)
    RAM (wx) : ORIGIN = 0x118000, LENGTH = (32 * 1K)
 ...
 *(.iplt)
 ...
 __rom_region_start = (0xe0000 + 0x0);
    rom_start :
 {
 ...
 *(".kernel_noinit.*")
    ...
    __kernel_ram_end = 0x118000 + (32 * 1K);
